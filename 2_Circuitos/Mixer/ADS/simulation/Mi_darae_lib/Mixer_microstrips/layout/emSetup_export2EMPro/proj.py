...
class projImporter():
	...
	def initNetlists(self):
		netlistNames = ['net_0','net_1_N__14','net_2']
	...
	def create_geometry(self,topAssembly):
		...
		assembly=empro.geometry.Assembly()
		part=empro.geometry.Model()
		simBox = empro.geometry.Box( _createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox-xLowerBoundingBox", "abs((-0.0533504-xLowerExtension)-(0.0336561+xUpperExtension))"), _createIfToggleExtensionToBoundingBoxExpression("zUpperBoundingBox-zLowerBoundingBox", "((((stack_tech_layer_7_Z) + (zUpperExtension)) - ((stack_tech_layer_1_Z) - (zLowerExtension))))"), _createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox-yLowerBoundingBox" , " abs((-0.04813-yLowerExtension)-(0.00262+yUpperExtension))"))
		part.recipe.append(simBox)
		part.coordinateSystem.anchorPoint = empro.geometry.CoordinateSystemPositionExpression(V(_createIfToggleExtensionToBoundingBoxExpression("(xUpperBoundingBox+xLowerBoundingBox)/2", "(0.0336561+xUpperExtension+-0.0533504-xLowerExtension)/2"), _createIfToggleExtensionToBoundingBoxExpression("(yUpperBoundingBox+yLowerBoundingBox)/2", "(0.00262+yUpperExtension+-0.04813-yLowerExtension)/2"), _createIfToggleExtensionToBoundingBoxExpression("zLowerBoundingBox","(((stack_tech_layer_1_Z) - (zLowerExtension)) - (0))")))
		...
		self.session.adjust_view()
		assembly=empro.geometry.Assembly()
		pointString='0.0336561+xUpperExtension#-0.04813-yLowerExtension;0.0336561+xUpperExtension#0.00262+yUpperExtension;-0.0533504-xLowerExtension#0.00262+yUpperExtension;-0.0533504-xLowerExtension#-0.04813-yLowerExtension'
		sketch = self._create_sketch(pointString)
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex0",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0533504-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","-0.04813-yLowerExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex1",V(_createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox","0.0336561+xUpperExtension"),_createIfToggleExtensionToBoundingBoxExpression("yLowerBoundingBox","-0.04813-yLowerExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex2",V(_createIfToggleExtensionToBoundingBoxExpression("xUpperBoundingBox","0.0336561+xUpperExtension"),_createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox","0.00262+yUpperExtension"),0)))
		sketch.constraintManager().append(empro.geometry.FixedPositionConstraint("vertex3",V(_createIfToggleExtensionToBoundingBoxExpression("xLowerBoundingBox","-0.0533504-xLowerExtension"),_createIfToggleExtensionToBoundingBoxExpression("yUpperBoundingBox","0.00262+yUpperExtension"),0)))
		part=empro.geometry.Model()
		...
		topAssembly.append(assembly)
		assembly=empro.geometry.Assembly()
		pointStrings=['0.0155548#-0.0220202;0.0155548#-0.0018202;0.0121696#0.001565;0.0006896#0.001565;0.0006896#0.00262;-0.0418704#0.00262;-0.0418704#0.001565;-0.0533504#0.001565;-0.0533504#-0.001395;-0.0433504#-0.001395;-0.0433504#-0.044115;-0.0533504#-0.044115;-0.0533504#-0.047075;-0.0418704#-0.047075;-0.0418704#-0.04813;0.0006896#-0.04813;0.0006896#-0.047075;0.0121696#-0.047075;0.0155548#-0.0436898;0.0155548#-0.0232898;0.0125948#-0.0232898;0.0125948#-0.044115;0.0021696#-0.044115;0.0021696#-0.001395;0.0125948#-0.001395;0.0125948#-0.0220202']
		pointStrings.append('-0.0403904#-0.00245;-0.0007904#-0.00245;-0.0007904#-0.04306;-0.0403904#-0.04306')
		...
		pointStrings=['0.0257#-0.0304;0.0257#-0.0257;0.021#-0.0257;0.021#-0.0304']
		part = self._create_extrude(pointStrings, "(mask_cond_Zmax) - (mask_cond_Zmin)", up=True)
		part.coordinateSystem.anchorPoint = empro.geometry.CoordinateSystemPositionExpression(V(0,0,"(mask_cond_Zmin) - (0)"))
		part.setAttribute('LtdLayerNumber', 2)
		part.meshParameters=empro.mesh.ModelMeshParameters()
		...
		pointStrings=['0.0336561#-0.0184898;0.0336561#-0.0174898;0.0311284#-0.0174898;0.0311284#-0.0184898']
		part = self._create_extrude(pointStrings, "(mask_cond_Zmax) - (mask_cond_Zmin)", up=True)
		part.coordinateSystem.anchorPoint = empro.geometry.CoordinateSystemPositionExpression(V(0,0,"(mask_cond_Zmin) - (0)"))
		part.setAttribute('LtdLayerNumber', 2)
		part.meshParameters=empro.mesh.ModelMeshParameters()
	...
	def create_parameters(self):
		...
		self._create_parameter("stack_tech_layer_5_Z", "1.5925 mm", "Z of topology level (level 5 of stack tech)",True,fixGridAxis='Z')
		self._create_parameter("stack_tech_layer_7_Z", "1.605 mm", "Z of topology level (level 7 of stack tech)",True,fixGridAxis='Z')
		...
		self._create_parameter("mask_cond_cond2_Zmax",str("1.5925 mm"),"Zmax of mask cond_cond2",True,fixGridAxis='Z')
		self._create_parameter("mask_cond_Zmin",str("1.5925 mm"),"Zmin of mask cond",True,fixGridAxis='Z')
		self._create_parameter("mask_cond_Zmax",str("1.605 mm"),"Zmax of mask cond",True,fixGridAxis='Z')
